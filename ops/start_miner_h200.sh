...
export RELIQUARY_HOT_SWAP=0        # DÉSACTIVÉ 2026-08-15 : gel live (self-gate a bloqué la boucle 8 min, fenêtre 28973 perdue) — à re-déboguer hors-ligne avant réactivation
